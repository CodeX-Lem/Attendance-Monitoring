<div class="d-flex justify-content-between mb-2 gap-2">
    ...
    <ul class="pagination m-0 align-items-center">
        ...
        @else
        <li class="page-item"><a class="page-link shadow-none rounded-0" href="{{ $pageData->previousPageUrl() }}&entries={{ $entries }}&search={{ $search }}" rel="prev">Previous</a></li>
        @endif
        ...
        @else
        <li class="page-item"><a class="page-link shadow-none rounded-0" href="{{ $pageData->nextPageUrl() }}&entries={{ $entries }}&search={{ $search }}" rel="next">Next</a>
        </li>
        @endif
    </ul>
</div>