...
<div class="h-100 overflow-y-auto">
    ...
    <form action="{{ route('admin.trainors.store') }}" method="POST">
        ...
        <div class="row mb-2 m-0 gx-3 gy-2">
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                ...
                <input type="text" class="form-control shadow-none rounded-0" name="contact_no" autocomplete="off"
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control shadow-none rounded-0" name="address" autocomplete="off"
                    value="{{ old('address') }}">
                @error('address')
                <div class="form-text text-danger mt-2">{{ $message }}</div>
                @enderror
