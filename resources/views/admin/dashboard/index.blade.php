...
<div class="row mx-0 g-3">
    <div class="col-sm-6 col-xl-3">
        <div class="card rounded-0 border-0 text-bg-primary card-dashboard h-100">
            ...
            <div class="card-footer border-0 p-0">
                <a href="{{ route('admin.students.index') }}" class="text-decoration-none d-block text-center py-1 card-dashboard__link">More
                    Info</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card rounded-0 border-0 text-bg-success card-dashboard h-100">
            ...
            <div class="card-footer border-0 p-0">
                <a href="{{ route('admin.trainors.index') }}" class="text-decoration-none d-block text-center py-1 card-dashboard__link">More
                    Info</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card rounded-0 border-0 text-bg-danger card-dashboard h-100">
            ...
            <div class="card-footer border-0 p-0">
                <a href="{{ route('admin.courses.index') }}" class="text-decoration-none d-block text-center py-1 card-dashboard__link">More
                    Info</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card rounded-0 border-0 bg-warning text-white card-dashboard h-100">
            <div class="card-body d-block d-md-flex">
                ...
                <div class="d-none d-md-block" style="opacity: 0.5;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
