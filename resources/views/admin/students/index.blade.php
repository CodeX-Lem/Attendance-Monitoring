...
<div class="table-responsive h-100">
    <form action="{{ route('admin.students.index') }}" method="GET"
        class="row align-items-center gy-2 gx-0 m-0 mb-2 sticky-left">
    ...
    <div class="row m-0 mb-2 gx-0 sticky-left" style="z-index: 3;">
        ...
        <div class="col-auto">
            <div class="dropdown">
                <button type="button" class="btn btn-warning btn-sm rounded-0 shadow-none dropdown-toggle"
                    data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                    Import
                </button>
                <form action="{{ route('admin.students.import') }}" method="POST" class="dropdown-menu p-4 rounded-0"
                    style="width: 300px;" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <input type="file" class="d-none" name="student_file" id="student_file" accept=".xlsx, .xls, .csv"
                        onchange="this.form.submit()">
                </form>
            </div>
        </div>
