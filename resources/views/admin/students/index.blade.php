...
<div class="p-0 p-sm-4">
    <div class="border bg-white p-0 p-sm-3">
        <div class="container-fluid">
            <form action="{{ route('admin.students.index') }}" method="GET" class="row align-items-center justify-content-end mt-3 mt-sm-0">
                ...
                <div class="col-auto">
                    <select class="form-select form-select-sm rounded-0 shadow-none" name="course_id" onchange="this.form.submit()">
                        ...
                        <option value="{{ $course->id }}" @if($course->id == $selectedCourse) selected @endif>{{ $course->course }}</option>
                        @endforeach
                    </select>
                 </div>
