...
<div class="p-0 p-sm-4">
    <div class="border bg-white p-3">
        ...
        <hr>
        <form action="{{ route('admin.students.update', ['id' => $student->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-select shadow-none rounded-0" name="scholarship_type">
                        <option value="NFTWSP" @if($student->scholarship_type =='NFTWSP' ) selected @endif>NFTWSP</option>
