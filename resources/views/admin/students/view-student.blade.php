        ...
        <div class="col-xl-3">
            <div class="border mb-3 profile" style="width: 200px; height: 200px">
                <label for="image" class="h-100 w-100">
                    ...
                    @else
                    <img src="{{ asset('no-image.png') }}" alt="Profile Pic" style="width:100%; height:100%;cursor:pointer; object-fit:cover;">
                    @endif
                </label>
                <form action="{{ route('admin.students.change-profile', ['id' => $student->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
