    ...
    <div class="border bg-white p-3">
        ...
        <div class="d-flex align-items-center justify-content-end mb-5 ">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="{{ route('admin.students.reject', ['id' => $student->id]) }}"
        ...
        <div class="row">
            <div class="col-xl-3">
                <div class="border mb-3 profile" style="width: 200px; height: 200px">
                    ...
                    <form action="{{ route('admin.students.change-profile', ['id' => $student->id]) }}" method="POST"
            ...
            <div class="col-xl-6 order-3 order-xl-2">
                ...
                <div class="mb-3 d-flex align-items-center gap-2">
                    <a href="{{ old('previous_url', $previousUrl) }}"
                        class="btn btn-primary btn-sm rounded-0 shadow-none">
                        Go Back
                    </a>
                </div>
            </div>
