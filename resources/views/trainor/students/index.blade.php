...
<div class="p-0 p-sm-4">
    <div class="border bg-white p-0 p-sm-3">
        <div class="container-fluid">
            <div class="row gx-1 mt-3 mt-sm-0">
                <div class="col-12 mb-2">
                    <form action="{{ route('trainor.students.index') }}" method="GET"
                        class="row align-items-center justify-content-end gy-3 gx-2">
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control shadow-none rounded-0"
                                    placeholder="Search any student" name="search" autocomplete="off" autofocus>
                                <button type="submit"
                ...
                <div class="col-auto ms-auto">
                    <a href="{{ route('trainor.students.create') }}"
                ...
                <div class="col-auto">
                    <form action="{{route('trainor.students.import')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <label for="student_file" class="btn btn-warning btn-sm shadow-none rounded-0">Import</label>
                        <input id="student_file" class="d-none" type="file" name="student_file"
                            accept=".xlsx, .csv, .xls" onchange="this.form.submit()">
                    </form>
                </div>
            </div>
                ...
                <table class="table table-bordered table-striped align-middle" style="font-size: 14px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span
                                    class="badge {{ $student->accepted ? 'text-bg-success' : 'text-bg-danger' }}">{{ $student->accepted ? 'Accepted' : 'Pending' }}</span>
                            </td>
                            <td>
                                <div class="d-flex justify-content-end">
                                    <div class="dropdown">
                                        <button data-bs-offset="0,-55" class="dropdown-toggle border-1"
                                        ...
                                        <ul class="dropdown-menu text-small shadow rounded-0">
                                            ...
                                            <li>
                                                <a href="{{ route('trainor.students.view-student', ['id' => $student->id]) }}"
                                                    class="dropdown-item">
                                                    View Info
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('trainor.students.show', ['id' => $student->id]) }}"
                                                    class="dropdown-item">
                                                    Edit
                                                </a>
                                            </li>
                    ...
                    <div class="col-auto">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <form action="{{ route('trainor.students.index') }}">
                                ...
                                <input type="hidden" class="form-control shadow-none rounded-0"
                                    name="training_completed" value="{{ request('training_completed', '0') }}">
