...
<div class="table-responsive h-100">
    <form action="{{ route('trainor.reports.index') }}" method="GET"
        class="row m-0 gx-0 align-items-center sticky-left">
        <div class="col-auto">
    ...
    <form action="{{ route('trainor.reports.download') }}" method="GET" class="mx-0 my-2 sticky-left">
