...
<div class="p-0 p-sm-4">
    <div class="border bg-white p-0 p-sm-3">
        <div class="container-fluid">
            <form action="{{ route('trainor.reports.index') }}" method="GET" class="row align-items-center mt-3 mt-sm-0">
                <div class="col-lg-6">
            ...
            <div class="table-responsive mt-3">
                <form action="{{ route('trainor.reports.download') }}" method="GET" class="mb-2">
